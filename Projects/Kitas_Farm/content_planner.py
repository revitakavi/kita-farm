...
def fact_check_topic(category, topic):
    ...
    if context:
        prompt = (
            ...
            f"เขียนสรุปข้อเท็จจริงสั้นๆ 3 ข้อสำคัญที่เป็นภาษาไทยเข้าใจง่าย เพื่อใช้ทำสคริปต์วิดีโอ"
        )
    else:
        prompt = (
            f"คำสั่ง: วิเคราะห์หัวข้อเกี่ยวกับผักสลัด การดูแลแปลง หรือการเกษตร: '{topic}'\n"
            f"จงสรุปข้อเท็จจริงทางวิทยาศาสตร์ สุขภาพ หรือการเกษตรนี้ให้ถูกต้องและเข้าใจง่ายเป็นภาษาไทย 3 ข้อสำคัญ"
        )
...
def write_reels_script(category, topic, fact_details):
    ...
    prompt = (
        ...
        f"3. กฎเหล็กข้อห้ามภาษาแปลกปลอม (CRITICAL SCRIPT RULES):\n"
        f"- ห้ามแปลตรงตัวจากภาษาอื่นเด็ดขาด! ห้ามมีคำแปลกๆ หรือภาษาต่างด้าวใดๆ หลุดเข้ามา\n"
        f"- บทพากย์เขียนขึ้นเพื่อให้ 'น้องกิ๊ก' (พนักงานฟาร์ม) เป็นคนอัดเสียงและดำเนินเรื่อง สรรพนามแทนตัวต้องเป็น 'กิ๊ก' หรือ 'เรา' เท่านั้น ห้ามพูดว่า 'สวัสดีครับกิ๊ก' หรือมีข้อความทักทายคนพากย์ตัวเอง\n"
        f"- ความยาวของบทพากย์ (script) ต้องกระชับมาก พูดจริงจบได้ใน 30-40 วินาที (ไม่เกิน 90-100 คำภาษาไทย) เพื่อไม่ให้วิดีโอรวมเกิน 1 นาที\n"
